...
$IMConfig['images_url'] = str_replace( "xinha/plugins/ImageManager/backend.php", "", $_SERVER["PHP_SELF"] ) . "pictures";
#$IMConfig['images_url'] = "./pictures";
$IMConfig['images_url'] = preg_replace("$\/(.+)\/pictures$", "pictures", $IMConfig['images_url']); # replaces absolute paths with relative paths
